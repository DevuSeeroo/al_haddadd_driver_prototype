...
class LocaleKeys {
  LocaleKeys._();
  static const titleAlHaddad = 'titleAlHaddad';
  static const cancelErrorMessage = 'cancelErrorMessage';
  static const timeoutErrorMessage = 'timeoutErrorMessage';
  ...
  static const invalidStatusErrorMessage = 'invalidStatusErrorMessage';
  static const noConnectionErrorMessage = 'noConnectionErrorMessage';
...
class Locales {
  static const ar_QA = {
    ...
    'cancelErrorMessage': 'تم إلغاء الطلب',
    'timeoutErrorMessage': 'نفذ الوقت',
    'oops': 'عذراً',
    'login': 'تسجيل الدخول',
    'sorry': 'المعذرة',
    'yes': 'نعم',
    ...
    'invalidStatusErrorMessage': 'الحالة غير صحيحة',
    'noConnectionErrorMessage': 'لا يوجد اتصال',
    'error': 'خطأ!',
    'success': 'نجح!',
    ...
    'jobId': 'Job ID',
    'logout': 'تسجيل الخروج',
    'logoutMessage': 'هل تريد حقًا تسجيل الخروج؟',
  ...
  static const en_US = {
    'titleAlHaddad': 'Al haddad Driver',
    'cancelErrorMessage': 'Request was cancelled',
    ...
    'invalidStatusErrorMessage': 'Invalid Status',
    'noConnectionErrorMessage': 'No Connection',
    'error': 'Error!',
    'success': 'Success!',
